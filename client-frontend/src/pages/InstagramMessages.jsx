...
const InstagramMessages = () => {
  ...
  const { data: messagesData, isLoading, error, refetch } = useQuery({
    queryKey: ['instagramMessages', selectedStatus, searchTerm],
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-red-600 mb-4">Failed to load Instagram messages</p>
          <button
            onClick={() => refetch()}
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Instagram Messages</h1>
            <p className="text-gray-600">Direct messages from Instagram</p>
          </div>
        </div>
        <button
          onClick={() => refetch()}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search Instagram conversations..."
                value={searchTerm}
            ...
            <div className="max-h-96 overflow-y-auto">
              {conversations.length > 0 ? (
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-gray-900 truncate">
                            {conversation.customerName || 'Instagram User'}
                          </p>
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="text-gray-500">No Instagram conversations found</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-4 py-3 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-pink-50">
              <h3 className="text-lg font-medium text-gray-900 flex items-center">
                <Instagram className="h-5 w-5 text-pink-600 mr-2" />
                {selectedConversation ? selectedConversation.customerName || 'Instagram User' : 'Select a conversation'}
              </h3>
            </div>
            <div className="h-[600px] flex flex-col bg-gray-50">
              {selectedConversation ? (
                <>
                  ...
                  <div className="border-t border-gray-200 p-4 bg-white">
                    <form onSubmit={handleSendMessage} className="flex space-x-2">
                      ...
                      <button
                        type="submit"
                        className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-md hover:from-purple-600 hover:to-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-500"
                      >
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center">
                    <Instagram className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                    <p className="text-gray-500">Select an Instagram conversation to view messages</p>
                  </div>
                </div>
              )}
            </div>
